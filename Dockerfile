...
ADD https://github.com/magento/magento2/archive/refs/tags/2.4.6-p3.tar.gz /tmp/magento.tar.gz
ADD https://github.com/magento/magento2-sample-data/archive/refs/tags/2.4.6-p3.tar.gz /tmp/sample-data.tar.gz
